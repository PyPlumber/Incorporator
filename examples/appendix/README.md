...
| [`espn-league-history/`](./espn-league-history/) | T9 | One-shot `fjord()` multi-season ETL: every reachable ESPN Fantasy Football season fused into six all-time analytical views. |
